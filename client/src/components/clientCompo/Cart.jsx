        ...
        {cart.length > 0 ? (
          ...
          >
            ...
            {cart.map((item) => (
              <div
                key={item.id}
                className="flex items-center gap-6 p-4 border-b border-gray-300 bg-white/60 rounded-lg shadow-sm mb-3"
              >
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center justify-between mt-3">
                    <div className="flex items-center gap-3">
                      <button
                        className="bg-gray-800 text-white rounded-lg px-3 py-1 hover:bg-gray-900 transition"
          ...
          <div className="text-center">
            ...
            <button
              onClick={() =>
                categories.length > 0
                  ? navigate(`/categoryproducts/${categories[0].id}`)
                  : navigate("/")
              }
